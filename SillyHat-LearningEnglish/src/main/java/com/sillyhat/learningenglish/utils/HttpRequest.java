...
//        String url = "http://fanyi.youdao.com/openapi.do?keyfrom=SillyHatYouDao&key=987724779&type=data&doctype=json&version=1.1&q=test";
        String url = "http://dict.youdao.com/speech";
        String params = "audio=interface";
        //发送 GET 请求
