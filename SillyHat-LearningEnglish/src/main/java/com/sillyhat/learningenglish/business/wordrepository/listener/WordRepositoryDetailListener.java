 ...
 */
public class WordRepositoryDetailListener implements ActionListener {
    ...
    public WordRepositoryDetailListener(SillyHatPageTable sillyHatPageTable, boolean isEdit){
        this.isEdit = isEdit;
